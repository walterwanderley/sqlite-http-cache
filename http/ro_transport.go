...
func newReadOnlyTransport(base http.RoundTripper, sqlDB *sql.DB, cacheableStatus []int, ttl time.Duration, cleanupInterval time.Duration, tableNames ...string) (*readOnlyTransport, error) {
	if base == nil {
